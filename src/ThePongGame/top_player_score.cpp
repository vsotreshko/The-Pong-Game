...
// Static resources
unique_ptr<Mesh> TopPlayerScore::mesh;
unique_ptr<Texture> TopPlayerScore::texture;
unique_ptr<Shader> TopPlayerScore::shader;

map<std::string, int> TopPlayerScore::material_map;
vector<tinyobj::material_t> TopPlayerScore::material;
...
bool TopPlayerScore::update(Scene &scene, float dt) {
...
void TopPlayerScore::render(Scene &scene) {
    shader->use();
